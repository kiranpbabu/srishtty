...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        if any(colors_changed):
            variables = [
                {"name": "o-brand-odoo", "value": self.theme_color_brand or "#008DCA"},
                {
                    "name": "o-brand-primary",
                    "value": self.theme_color_primary or "#008DCA",
                },
                {
                    "name": "mk-required-color",
                    "value": self.theme_color_required or "#90D5F8",
                },
                {"name": "mk-apps-color", "value": self.theme_color_menu or "#FFFFFF"},
                {
        ...
        param.set_param(
            "muk_web_theme.background_blend_mode", self.theme_background_blend_mode
        )
        return res
        ...
        res.update(
            {
                ...
                "theme_background_blend_mode": params.get_param(
                    "muk_web_theme.background_blend_mode", "normal"
                ),
            }
        )
        return res
