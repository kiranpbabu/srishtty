...
(function (global, factory) {
    ...
    var _redefine = createCommonjsModule(function (module) {
        ...
        (module.exports = function (O, key, val, safe) {
            ...
            if (isFunction)
                _has(val, SRC) ||
                    _hide(val, SRC, O[key] ? String(O[key]) : TPL.join(String(key)));
            if (O === _global) {
                O[key] = val;
            } else if (!safe) {
                delete O[key];
    ...
    NAME in FProto ||
        (_descriptors &&
            dP$1(FProto, NAME, {
                ...
                get: function () {
                    try {
                        return String(this).match(nameRE)[1];
                    } catch (e) {
                        return "";
                    }
                },
    ...
    var _iterStep = function (done, value) {
        return {value: value, done: Boolean(done)};
    };
    ...
    function toNumber$1(value) {
        ...
        if (isObject$1(value)) {
            var other = typeof value.valueOf === "function" ? value.valueOf() : value;
            value = isObject$1(other) ? String(other) : other;
        }
        if (typeof value !== "string") {
            return value === 0 ? value : Number(value);
        }
    ...
    var MapShim = (function () {
        ...
        return /** @class */ (function () {
            ...
            class_1.prototype.has = function (key) {
                return Boolean(~getIndex(this.__entries__, key));
            };
            /**
             * @returns {void}
             */
    ...
    var ResizeObserverController = /** @class */ (function () {
        ...
        ResizeObserverController.prototype.onTransitionEnd_ = function (_a) {
            ...
            var isReflowProperty = transitionKeys.some(function (key) {
                return Boolean(~propertyName.indexOf(key));
            });
            if (isReflowProperty) {
                this.refresh();
            }
        ...
        (function () {
            function SimpleBar(element, options) {
                ...
                this.drag = function (e) {
                    ...
                    var scrollPos =
                        dragPerc *
                        _this.contentEl[_this.axis[_this.draggedAxis].scrollSizeAttr]; // Fix browsers inconsistency on RTL
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function initDOM() {
                            ...
                            if (
                                ...
                                this.heightAutoObserverEl = document.createElement(
                                    "div"
                                );
                    ...
                    },
                    {
                        ...
                        value: function initListeners() {
                            ...
                            [
                                ...
                                _this3.el.addEventListener(
                                    e,
                                    _this3.onPointerEvent,
                                    true
                                );
                            });
                    ...
                    },
                    {
                        ...
                        value: function recalculate() {
                            var isHeightAuto =
                                this.heightAutoObserverEl.offsetHeight <= 1;
                            ...
                            this.contentEl.style.height = isHeightAuto
                                ? "auto"
                                : "100%";
                        ...
                        value: function positionScrollbar() {
                            var axis =
                                arguments.length > 0 && arguments[0] !== undefined
                                    ? arguments[0]
                                    : "y";
                            var contentSize = this.contentEl[
                            ...
                            var scrollOffset = this.contentEl[
                            ...
                            scrollOffset =
                                ...
                                SimpleBar.getRtlHelpers().isRtlScrollingInverted
                                    ...
                                    : scrollOffset;
                            var scrollPourcent =
                                scrollOffset / (contentSize - hostSize);
                            var handleOffset = ~~(
                    ...
                    },
                    {
                        ...
                        value: function toggleTrackVisibility() {
                            ...
                            if (
                                ...
                                this.contentEl.style[this.axis[axis].overflowAttr] =
                                    "scroll";
                            } else {
                    ...
                    },
                    {
                        ...
                        value: function onMouseMoveForAxis() {
                            ...
                            if (this.isWithinBounds(this.axis[axis].track.rect)) {
                                ...
                                this.axis[axis].track.el.classList.add(
                                    this.classNames.hover
                                );
                            } else {
                ...
                [
                    {
                        ...
                        value: function getRtlHelpers() {
                            ...
                            var dummyContainerChild =
                                scrollbarDummyEl.firstElementChild;
                            scrollbarDummyEl.scrollLeft = 0;
                            var dummyContainerOffset = SimpleBar.getOffset(
                                scrollbarDummyEl
                            );
                    ...
                    },
                    {
                        ...
                        value: function getElOptions(el) {
                            var options = Array.from(el.attributes).reduce(function (
                                ...
                                var option = attribute.name.match(
                                    /data-simplebar-(.+)/
                                );

                                if (option) {
                                    var key = option[1].replace(/\W+(.)/g, function (
                                        x,
                                        chr
                                    ) {
